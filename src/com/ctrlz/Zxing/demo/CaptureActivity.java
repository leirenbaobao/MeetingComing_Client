...
import com.ctrlz.Zxing.demo.camera.CameraManager;
import com.ctrlz.Zxing.demo.decoding.CaptureActivityHandler;
import com.ctrlz.Zxing.demo.decoding.InactivityTimer;
...
public class CaptureActivity extends Activity implements Callback
{
	...
	private Map<String, String> mapForSign;
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		mapForSign = new HashMap<String, String>();
	...
	public void handleDecode(final Result obj, Bitmap barcode)
	{
		...
		dialog.setNegativeButton("确认", new DialogInterface.OnClickListener()
		{
			...
			public void onClick(DialogInterface dialog, int which)
			{
				...
				mapForSign.put("scanUrl", content_url.toString());
				mapForSign.put("staffId", MCApplication.getHolderStaffId());
	...
	private class SignTask extends AsyncTask<String, Integer, String>{
		...
		protected String doInBackground(String... arg0) {
			// TODO Auto-generated method stub
			return HttpInterface.Sign(mapForSign);
		}
			...
			try {
				...
				if(ret.equals("0")){
					...
					if(value.equals("true")){
						...
						intent.setClass(CaptureActivity.this, ScanResult.class);
						startActivity(intent);
						finish();
						
					}else{
						ToastUtils.showShort(CaptureActivity.this, "签到失败");
						finish();
					}
